        ...
        <CardContent className="p-4 sm:p-6 pt-0 sm:pt-0">
          ...
          <div className="mt-3 sm:mt-4">
            <div className="text-xs text-muted-foreground">
              {processedContent ? (
                <span>Variables filled! Your customized values are highlighted in <span className="filled-variable text-xs">red</span> within the curly braces above.</span>
              ) : (
                <span>Tip: Variables in <span className="template-variable text-xs">{`{{red}}`}</span> can be customized above</span>
              )}
            </div>
          </div>
        </CardContent>
